@php
    ...
    $sidebarMenuLists = [
        ...
        'Menu' => [
            ...
            [
                'active_route' => 'roles.and.permissions.*',
                'route' => 'roles.and.permissions.index',
                'icon' => 'bx bx-sm bx-key',
                'label' => 'Role and Permission',
                'permission' => 'view_roles_and_permissions',
                'new_tab' => false,
            ],
            // Adding the Division menu item
            [
                'active_route' => 'divisions.*',
                'route' => 'divisions.index',
                'icon' => 'bx bx-sm bx-building',
                'label' => 'Division',
                'permission' => 'view_divisions',
                'new_tab' => false,
            ],
            // Adding the Risk menu item
            [
                'active_route' => 'risks.*',
                'route' => 'risks.index',
                'icon' => 'bx bx-sm bx-error',
                'label' => 'Risk',
                        ...
                        @can($items['permission'] ?? '')
                            <li class="sidebar-item{{ isActive($items['active_route']) ? ' active' : '' }}">
                                <a href="{{ route($items['route']) }}" class='sidebar-link'
                                    target="{{ $items['new_tab'] ? '_blank' : '_self' }}">
