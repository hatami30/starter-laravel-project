            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>Edit Peran dan Izin</h3>
                        <p class="text-subtitle text-muted">Edit peran dan perbarui izinnya.</p>
                    </div>
                </div>
            </div>
        </div>

        <!-- Formulir Edit Peran mulai -->
                                ...
                                <form method="POST" action="{{ route('roles.and.permissions.update', $role->id) }}">
                                    ...
                                    <div class="form-group mandatory mb-4">
                                        ...
                                        @foreach ($permissions as $module => $modulePermissions)
                                            <div class="mb-4">
                                                <!-- Header Modul dengan Expand/Collapse -->
