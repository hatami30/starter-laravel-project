            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-12 col-md-6 order-md-1 order-last">
                        <h3>New Risk</h3>
                        <p class="text-subtitle text-muted">Create a new risk entry.</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <form method="POST" action="{{ route('risks.store') }}">
                                    ...
                                    <div class="form-group mandatory mb-3">
                                        ...
                                        <select class="form-control @error('relevant_committee') is-invalid @enderror"
                                            ...
                                            <option value="Ethics"
                                                {{ old('relevant_committee') == 'Ethics' ? 'selected' : '' }}>Ethics
                                            </option>
                                            ...
                                            <option value="Medical"
                                                {{ old('relevant_committee') == 'Medical' ? 'selected' : '' }}>Medical
                                            </option>
                                            ...
                                            <option value="Nursing"
                                                {{ old('relevant_committee') == 'Nursing' ? 'selected' : '' }}>Nursing
                                            </option>
                                            ...
                                            <option value="Pain Management"
                                                {{ old('relevant_committee') == 'Pain Management' ? 'selected' : '' }}>Pain
                                                Management</option>
                                            ...
                                            <option value="Quality"
                                                {{ old('relevant_committee') == 'Quality' ? 'selected' : '' }}>Quality
                                            </option>
                                            ...
                                            <option value="Nil"
                                                {{ old('relevant_committee') == 'Nil' ? 'selected' : '' }}>Nil</option>
                                        </select>
                                    ...
                                    <div class="form-group mandatory mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="Yes"
                                                {{ old('notify_of_associated_incidents') == 'Yes' ? 'selected' : '' }}>Yes
                                            </option>
                                            <option value="No"
                                                {{ old('notify_of_associated_incidents') == 'No' ? 'selected' : '' }}>No
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group mandatory mb-3">
                                        ...
                                        <select class="form-control @error('control') is-invalid @enderror"
                                            ...
                                            <option value="Moderate" {{ old('control') == 'Moderate' ? 'selected' : '' }}>
                                                Moderate</option>
                                            <option value="Major" {{ old('control') == 'Major' ? 'selected' : '' }}>Major
                                            </option>
                                    ...
                                    <div class="form-group mandatory mb-3">
                                        ...
                                        <select class="form-control @error('assessment') is-invalid @enderror"
                                            ...
                                            <option value="Ineffective"
                                                {{ old('assessment') == 'Ineffective' ? 'selected' : '' }}>Ineffective
                                            </option>
                                    ...
                                    <div class="form-group mandatory mb-3">
                                        ...
                                        <select
                                            ...
                                            <option value="Excellent"
                                                ...
                                                Excellent</option>
                                            <option value="Good"
                                                {{ old('overall_control_assessment') == 'Good' ? 'selected' : '' }}>Good
                                            </option>
                                            <option value="Moderate"
                                                {{ old('overall_control_assessment') == 'Moderate' ? 'selected' : '' }}>
                                                Moderate</option>
                                            <option value="Poor"
                                                {{ old('overall_control_assessment') == 'Poor' ? 'selected' : '' }}>Poor
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group mandatory mb-3">
                                        ...
                                        <select class="form-control @error('residual_likelihood') is-invalid @enderror"
                                            ...
                                            <option value="Frequent"
                                                {{ old('residual_likelihood') == 'Frequent' ? 'selected' : '' }}>Frequent
                                            </option>
                                            <option value="Likely"
                                                {{ old('residual_likelihood') == 'Likely' ? 'selected' : '' }}>Likely
                                            </option>
                                            <option value="Possible"
                                                {{ old('residual_likelihood') == 'Possible' ? 'selected' : '' }}>Possible
                                            </option>
                                            <option value="Unlikely"
                                                {{ old('residual_likelihood') == 'Unlikely' ? 'selected' : '' }}>Unlikely
                                            </option>
                                            <option value="Rare"
                                                {{ old('residual_likelihood') == 'Rare' ? 'selected' : '' }}>Rare</option>
                                        </select>
                                    ...
                                    <div class="form-group mandatory mb-3">
                                        ...
                                        <select class="form-control @error('assurance_category') is-invalid @enderror"
                                            ...
                                            <option value="Audit Reports"
                                                {{ old('assurance_category') == 'Audit Reports' ? 'selected' : '' }}>Audit
                                                Reports</option>
                                            <option value="Claims"
                                                {{ old('assurance_category') == 'Claims' ? 'selected' : '' }}>Claims
                                            </option>
                                            ...
                                            <option value="H&S Committee"
                                                {{ old('assurance_category') == 'H&S Committee' ? 'selected' : '' }}>H&S
                                                Committee</option>
                                            <option value="Incidents"
                                                {{ old('assurance_category') == 'Incidents' ? 'selected' : '' }}>Incidents
                                            </option>
                                            ...
                                            <option value="OHS Reports"
                                                {{ old('assurance_category') == 'OHS Reports' ? 'selected' : '' }}>OHS
                                                Reports</option>
